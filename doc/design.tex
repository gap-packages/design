...
This manual describes the {\DESIGN}~1.2 package for {\GAP} (version at
...
L.~H. Soicher, The {DESIGN} package for {GAP}, Version~1.2, 2006,
...
To install {\DESIGN}~1.2 (after installing {\GAP}, {\GRAPE} and
{\GAPDoc}), first obtain the {\DESIGN} archive file `design1r2.tar.gz',
...
containing `design1r2.tar.gz', and then run

\begintt
gunzip design1r2.tar.gz
tar -xf design1r2.tar
\endtt
